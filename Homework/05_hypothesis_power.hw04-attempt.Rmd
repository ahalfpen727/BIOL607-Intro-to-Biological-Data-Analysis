...
hrhdist<-rnorm(1-20, mean =80, sd=6)
hrhdist
sigma_rhr = 6/sqrt(20)
#Calculate SE based on the population
2*pbinom(80, size = 20, prob = 0.05)
...
avg.rhr<-c(seq(62,98, length.out=20))
avg.rhr

lhrh.avg<-which(avg.rhr>92)[1] 
hhrh.avg<-which(avg.rhr<68)[1]
lhrh.avg
hhrh.avg
prob_observed =  c(rep(0.9/20, 20), rep(0.1/20, 20))
samp <- sample(avg.rhr, 20, replace=TRUE,  prob = prob_observed)
