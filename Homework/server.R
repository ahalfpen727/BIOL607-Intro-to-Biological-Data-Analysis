...
shinyServer(function(input, output) {
   ...
   selectedData = reactive({
      ...
      selected_data = select_(google_data, GFTData = input$location, "Date")
   ...
   # Once we have selected our data, we can make our plot. We call our plot "google_plot",
   # the same name that is referenced in the ui.R file
